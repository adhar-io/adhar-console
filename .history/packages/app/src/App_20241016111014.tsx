...
import { SearchPage, searchPlugin, HomePageSearchBar } from '@backstage/plugin-search';
...
import {
  AdharConsoleHomepage,
  adharLightTheme,
  adharDarkTheme,
} from '@internal/plugin-adhar-console';
...
const app = createApp({
  ...
  bindRoutes({ bind }) {
    ...
    bind(searchPlugin.externalRoutes, {
      HomePageSearchBar: searchPlugin.routes.root,
    });
  },
  themes: [
    {
      ...
      icon: <LightIcon />,
      Provider: ({ children }) => (
        <UnifiedThemeProvider theme={adharLightTheme} children={children} />
      ),
    },
    {
      id: 'cnoe-dark-theme',
      ...
      icon: <LightIcon />,
      Provider: ({ children }) => (
        <UnifiedThemeProvider theme={adharDarkTheme} children={children} />
      ),
    },
  ],
});
...
const routes = (
  <FlatRoutes>
    ...
    <Route path="/home" element={<AdharConsoleHomepage />} />
