            ...
            <div className="space-y-3 rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="text-xs text-slate-500">
                ...
                {user.roles.map((r) => (
                  <span
                    key={r}
                    className="ml-1 rounded-md bg-slate-100 px-1.5 py-0.5 font-mono text-[11px] text-slate-700"
                  >
                    {r}
                  </span>
                ))}
              ...
              <a
                href="#"
                className="inline-flex rounded-md border border-slate-200 bg-white px-3 py-1.5 text-xs text-slate-700 hover:bg-slate-50"
              >
          ...
          {section === 'pats' && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-slate-900">Personal access tokens</h2>
                <button
                  type="button"
                  ...
                  { key: 'seen', header: 'Last seen', cell: (s) => formatRelative(s.lastSeen) },
                  {
                    ...
                    cell: (s) =>
                      s.current ? (
                        ...
                        <button
                          type="button"
                          className="rounded-md border border-rose-200 bg-white px-2.5 py-1 text-xs text-rose-700 hover:bg-rose-50"
                        >
                          Sign out
                        </button>
                      ),
